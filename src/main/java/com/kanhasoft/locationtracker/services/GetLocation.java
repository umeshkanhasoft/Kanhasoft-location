...
public class GetLocation extends Service implements LocationListener {
    ...
    public static final int TIME_BW_UPDATES = 1000; // 1 seconds
    public static final int MIN_DISTANCE_FOR_UPDATE = 1;     // 3 meter
    ...
    public void showGpsAlertDialog(Context cnt) {
    ...
    public void onLocationChanged(Location location) {
        if (location != null) {
            Log.i(GetLocation.class.getSimpleName(), "lat : " + location.getLatitude() + ", lon = " + location.getLongitude());
        } else {
